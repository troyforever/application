...
<html lang="zh-CN">
  ...
  <body onresize="resize()" onload="resize()">
    <div id="content">
      ...
      <input id="unit" style="width:300px" data-options="text:'计算机科学与通信工程学院',value:1"><br><br>
      <input id="department" style="width:300px" data-options="text:'科学系',value:1"><br><br>
      <input id="state" style="width:300px"><br><br>
      <input id="time" style="width:300px"><br><br><br>
      <a id="submit">提交</a>
