...
<html lang="zh-CN">
  <head>
    ...
    <link href="/application/Public/css/fgtpwd.css" rel="stylesheet">
  ...
  <body onresize="resize()" onload="resize()">
    <div id="box">
      <form id="login-box" method="POST">
        <div class="css1">
          ...
          <div class="css2">
       		<input id="code" />
       		<a id="recode"><span id="num"></span><span id="text">发送验证码</span></a>
       	 </div>
        </div>
        <div class="css3">
          <a id="setpwd" href="javascript:;" class="pull-right">重置密码</a>
        </div>
      </form>
    </div>
    ...
    <script src="/application/Public/js/fgtpwd.js"></script>
  </body>
</html>